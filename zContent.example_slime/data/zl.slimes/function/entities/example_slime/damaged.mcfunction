## UPDATE DISPLAYS
    ...
    ## DEATH ANIMATION
        ...
        execute at @s unless entity @e[tag=zl.entity.temp_current,distance=0,limit=1] on passengers run data merge entity @s {transformation:{left_rotation:[0f,0f,1f,-1f],translation:[0f,-1f,0f]},interpolation_duration:12,start_interpolation:0}

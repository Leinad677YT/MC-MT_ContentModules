...
data modify storage l.item:data zl_custom_tools."amethyst_netherite_boots" set value { \
    ...
    components: { \
        ...
        "minecraft:attribute_modifiers": [ \
            {id:"b-minecraft:explosion_knockback_resistance", amount: 1, operation:"add_value", type:"minecraft:explosion_knockback_resistance", display:{type:"default"}, slot:"feet"}, \
    ...
    enchantments: { \
        ...
        "zl.survival:fixed/crystallized": 5, \
    }, \
}
...
data modify storage l.item:data zl_custom_tools."amethyst_netherite_leggings" set value { \
    ...
    components: { \
        ...
        "minecraft:repairable":{items:"minecraft:amethyst_shard"}, \
        "minecraft:attribute_modifiers": [ \
            {id:"l-minecraft:explosion_knockback_resistance", amount: 1, operation:"add_value", type:"minecraft:explosion_knockback_resistance", display:{type:"default"}, slot:"legs"}, \
...
data modify storage l.item:data zl_custom_tools."amethyst_netherite_chestplate" set value { \
    ...
    components: { \
        ...
        "minecraft:enchantments":{ "minecraft:mending":0, "minecraft:unbreaking":0 }, \
        "minecraft:attribute_modifiers": [ \
            {id:"c-minecraft:explosion_knockback_resistance", amount: 1, operation:"add_value", type:"minecraft:explosion_knockback_resistance", display:{type:"default"}, slot:"chest"}, \
...
data modify storage l.item:data zl_custom_tools."amethyst_netherite_helmet" set value { \
    ...
    components: { \
        ...
        "minecraft:enchantments":{ "minecraft:mending":0, "minecraft:unbreaking":0 }, \
        "minecraft:attribute_modifiers": [ \
            {id:"h-minecraft:explosion_knockback_resistance", amount: 1, operation:"add_value", type:"minecraft:explosion_knockback_resistance", display:{type:"default"}, slot:"head"}, \
...
item replace entity @s armor.body with leather_boots[]
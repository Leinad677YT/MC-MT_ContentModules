...
data modify storage leinad_temp:game inf_garden.temp set value [{shape:7},{shape:8},{shape:9},{shape:10},{shape:10},{shape:10},{shape:10},{shape:11},{shape:12}]
        ...
        function zl.inf_garden:generation/zl_final/get_shape with storage leinad_temp:game inf_garden.generation
    ##

    ## STRUCTURE
        function zl.inf_garden:generation/zl_final/get_room_amount with storage leinad_temp:game inf_garden.generation
        function zl.inf_garden:generation/zl_final/get_room_target with storage leinad_temp:game inf_garden.generation
        ...
        function zl.inf_garden:generation/zl_final/redirect_place with storage leinad_temp:game inf_garden.generation
    ##
...
## LINK ROOMS
    function zl.inf_garden:generation/zl_final/check_connection with storage leinad_temp:game inf_garden.generation
##

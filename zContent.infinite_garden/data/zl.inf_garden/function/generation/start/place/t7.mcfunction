$execute positioned ^-7 ^ ^1 run place template $(structure) ~ 0 ~ $(rotation) none 1 677 strict
    ...
    ## ROOM VOLUME
        ...
        execute positioned ^16.1 ^ ^8.1 positioned ~ 0 ~ summon marker run function zl.inf_garden:generation/start/mark/marker_remove_forceload with storage leinad_temp:game inf_garden.generation
        ...
        execute positioned ^16.1 ^ ^24.1 positioned ~ 0 ~ summon marker run function zl.inf_garden:generation/start/mark/marker_fill with storage leinad_temp:game inf_garden.generation
        execute positioned ^16.1 ^ ^24.1 positioned ~ 0 ~ summon marker run function zl.inf_garden:generation/start/mark/marker_remove_forceload with storage leinad_temp:game inf_garden.generation
        execute positioned ^16.1 ^ ^24.1 positioned ~-8.0 0 ~-8.0 summon marker run function zl.inf_garden:generation/start/mark/marker_kill with storage leinad_temp:game inf_garden.generation
        # mark with dimension
